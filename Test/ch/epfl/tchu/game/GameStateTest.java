...
class GameStateTest {
    ...
    void topTickets() {
        ...
        GameState initial = GameState.initial(SortedBag.of(1, ticketA, 1, ticketB),new Random(6));
    ...
    void forNextTurn() {
        ...
        SortedBag<Card> cards = SortedBag.of(2, Card.GREEN);
        GameState initial = GameState.initial(SortedBag.of(1, ticketA, 1, ticketB), new Random(1));
        PlayerId currentplayer = initial.currentPlayerId();
        assertEquals(currentplayer, initial.currentPlayerId());
        assertEquals(currentplayer.next(), initial.forNextTurn().currentPlayerId());
        for (int i = 0; i < 19; i++) {
