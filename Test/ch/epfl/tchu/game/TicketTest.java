...
class TicketTest {
    ...
    @Test
    void constructorFailsWithFromsStationsWithDifferentName(){
        assertThrows(IllegalArgumentException.class, () -> {
            new Ticket(List.of(new Trip(new Station(1,"f"),new Station(2,"r"),2),new Trip(new Station(1,"l"),new Station(2,"p"),2)));
        });
