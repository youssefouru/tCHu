...
public class SerdesTest {
    ...
    @Test
    void readMEssage(){
        System.out.println(Serdes.STRING_SERDE.deserialize("QWRhIGpvdWVyYSBlbiBwcmVtaWVy"));
    }
    ...
    private boolean mapEqualizer(PublicGameState gameState1, PublicGameState gameState2) {
        for (PlayerId playerId : PlayerId.ALL) {
            if (!equalsPublicPlayerState(gameState1.playerState(playerId), gameState2.playerState(playerId)))
                return false;
        }
        return true;
    }
