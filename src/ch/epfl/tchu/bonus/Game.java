...
public final class Game {
    ...
    public static void play(Map<PlayerId, Player> players, Map<PlayerId, String> playerNames, SortedBag<Ticket> tickets, Random rng) {
        ...
        for (PlayerId playerId : PlayerId.ALL) {
            ...
            if (bonus == Constants.LONGEST_TRAIL_BONUS_POINTS) {
                Trail longest = mapOfTrails.get(playerId);
    ...
    private static void sendLonguest(Map<PlayerId,Player> players,List<Route> routes){
        players.forEach(((playerId, player) -> player.notifyLongest(routes)));
    }
